...
dirt_csv_dirt = dirt_base + "round_1/"#dirt of compare file
out_put_dirt = dirt_base + "round_1/round_2_inconsistent/"#dirt of output dirt, including cated fastq, assembly, and fasta files
temp_work_dirt = dirt_base + "round_1/round_2_inconsistent/temp/"# temp dirt used to cat fastq files
file_name = '1st_round_cmp.csv'
...
with open(out_put_dirt+'cluster_members_'+file_name[:3]+'.json') as input:
