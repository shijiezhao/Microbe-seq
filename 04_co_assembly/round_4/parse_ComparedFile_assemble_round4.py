...
dirt_csv_dirt = dirt_base + "round_1/round_2_inconsistent/round_3/"#dirt of compare file
out_put_dirt = dirt_base + "round_1/round_2_inconsistent/round_3/round_4/"#dirt of output dirt, including cated fastq, assembly, and fasta files
temp_work_dirt = dirt_base + "round_1/round_2_inconsistent/round_3/round_4/temp/"# temp dirt used to cat fastq files
...
for j in range(max(assignments)):
        ...
        for i in a_temp_list:
                for k in cluster_result_readin_2nd[i[:-len('.fasta')]]:
                        for h in cluster_result_readin_1st[k]:
                                a_temp_list_of_barcode += [h]
